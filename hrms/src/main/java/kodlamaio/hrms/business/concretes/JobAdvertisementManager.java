...
public class JobAdvertisementManager implements JobAdvertisementService{
	...
	@Override
	public DataResult<List<JobAdvertisement>> findAllEnableTrueOrderByApplicationDeadLineDesc() {
		
		return new SuccessDataResult<List<JobAdvertisement>>(jobAdvertisementDao.findAllByEnableTrueOrderByApplicationDeadLineDesc(), "İş İlanları Listelendi.");
	}
